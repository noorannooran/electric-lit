...
// F column
const verbs = ['re-awaken', 'come to grips with', 'grapple with', 'understand', 'explore', 'accept', 'overcome',
...
// G column
const possessions = ['fear of spiders', 'adoption', 'traumatic childhood', "mothers's death", 'sexless marriage', 'Oedipal complex', 'feminism',
